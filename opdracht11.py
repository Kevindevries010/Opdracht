...
# het jaar nummer begint op 2, omdat jaar 1 niet wordt mee genomen in de loop
...
for jaren in range(aantaljaar - 1):
    nieuwe_huur = basishuur / 100 * 101.75
    # de formule om de nieuwe huur te berekenen

    basishuur = nieuwe_huur
    # zo wordt de huurprijs steeds up to date gehouden

    basishuur = round(basishuur, 2)

    # hier ronden we de huurprijs af zodat het er netjes uitziet
